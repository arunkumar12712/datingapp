...
export class MemberDetailComponent implements OnInit, OnDestroy {
  ...
  constructor(private accountService: AccountService, private router: ActivatedRoute,
    private messageService: MessageService, public presenceService: PresenceService, private rout: Router) {
  ...
  selectTab(heading: string){
    if(this.memberTabs){
      this.memberTabs.tabs.find(x =>x.heading ==='Messages')!.active = true;
    }
